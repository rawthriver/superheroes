  ...
  testWidgets('module1', (WidgetTester tester) async {
    await mockNetworkImagesFor(() async {
      await tester.runAsync(() async {
        ...
        await tester.pumpWidget(MaterialApp(home: SuperheroesList(title: "Your favorites", stream: subject)));
        ...
        expect(
          ...
          reason: "There are no appropriate parameters added in ListView to hide keyboard on scroll",
        );
