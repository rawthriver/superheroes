...
import 'package:superheroes/widgets/superheroes_list.dart' as list;
...
void runTestLesson4Task2() {
  setUp(() {
    ...
    MethodChannel('plugins.flutter.io/path_provider').setMockMethodCallHandler((MethodCall methodCall) async {
      return ".";
    });
  });
        ...
        Material(
          child: Directionality(
            ...
            child: Provider.value(
              value: bloc,
              child: list.ListTile(
                hero: SuperheroInfo.fromSuperhero(superhero1),
                swipeEnabled: true,
              ),
            ),
          ),
