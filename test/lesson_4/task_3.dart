...
void runTestLesson4Task3() {
  ...
  testGoldens('module3', (WidgetTester tester) async {
    ...
    final uriCreator =
        (superheroId) => Uri.parse("https://superheroapi.com/api/${dotenv.env["SUPERHERO_TOKEN"]}/$superheroId");
      ...
      Center(
          child: (GoldenBuilder.column()
                ...
                ..addScenario(
                  'errorWidget',
                  widgetCreator(
                    (context) => cachedNetworkImage.errorWidget!(context, superhero1.image.url, Object()),
                  ),
                ))
              .build()),
